...
export const GenericLoginContainer = () => {
  ...
  return (
    <div style={{ height: '100%' }}>
      ...
      <ResetPasswordComponent
        ...
        handleResetPasswordOKClick={handleResetPasswordOKClick}
        resetPwdDetails={resetPwdDetails}
        handleResetPwdOnChange={handleResetPwdOnChange}
        handleResetPasswordShow={handleResetPasswordShow}
...
export default GenericLoginContainer;
