...
const ResetPasswordComponent = (props) => {
  ...
  return (
    <Dialog fullScreen={fullScreen} open={openRestPasswordDialog} aria-labelledby="responsive-dialog-title">
      <DialogTitle id="responsive-dialog-title">{'Reset Temporary Password to Continue'}</DialogTitle>
      {props.resetPasswordResponse !== undefined &&
      props.resetPasswordResponse.resetPasswordMessage !== null &&
      props.resetPasswordResponse.resetPasswordMessage === 'Unauthorized' ? (
